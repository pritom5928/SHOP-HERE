...
function updateproductCartCounter() {
    var productCartCounterList;
    var existingproductsInCartList = $.cookie('Cartproducts');

    if (existingproductsInCartList != null && existingproductsInCartList != "" && existingproductsInCartList != undefined) {

        productCartCounterList = existingproductsInCartList.split('-');

    }
    else {

        productCartCounterList = [];
    }

    $("#productsCartCounter").html(productCartCounterList.length);
}